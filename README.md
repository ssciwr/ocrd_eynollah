...
Then download a specific trained Eynollah model or all available models. See [ocrd-tool.json](ocrd_eynollah/ocrd-tool.json) for the list of available models.
...
Finally, run the Eynollah inference as an ocrd processor:
